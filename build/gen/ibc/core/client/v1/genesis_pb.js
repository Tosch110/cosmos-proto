...
proto.ibc.core.client.v1.GenesisState.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    createLocalhost: jspb.Message.getBooleanFieldWithDefault(msg, 4, false)
  };
...
proto.ibc.core.client.v1.GenesisState.prototype.getParams = function() {
  return /** @type{?proto.ibc.core.client.v1.Params} */ (
    jspb.Message.getWrapperField(this, ibc_core_client_v1_client_pb.Params, 3));
};
...
/**
 * optional bool create_localhost = 4;
 * @return {boolean}
 */
